-- 003: блокировки, общие для всех инстансов сервера.
--
...
-- спокойно заходил на другой. Таблица punishments для этого не годится — в
-- ней нет ни IP, ни HWID, ни MAC, ни Social Club, то есть ровно тех полей,
-- по которым бан и выдаётся.
--
