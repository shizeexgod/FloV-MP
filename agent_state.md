...
текущей Epic-установки. Основной путь — собственный версионный адаптер
клиентского слоя для Legacy 1.0.3889, при этом подтверждённый серверный и
alt:V 16.4.39-профиль сохраняется как эталон и не изменяется. План и первый
диагностический скрипт: `docs/engine/legacy-3889-plan.md` и
