...
- **Система фракций и организаций (`FloVMP.Core.Factions`):**
  - Пресеты для «Держава Онлайн»: Мэрия Москвы, ГУ МВД по г. Москве, УФСБ РФ, ГКБ им. Боткина, Воинская часть ВС РФ, Телеканал «Москва 24», Солнцевская ОПГ.
...
- **Система документов удостоверения личности (`FloVMP.Core.Documents`):**
  - Паспорт гражданина РФ (серия 45 ХХ, прописка, орган выдачи, бессрочный).
  - Водительское удостоверение с категориями A/B/C/D/Boat/Air, проверка прав на транспорт.
  - Лицензия на оружие РОХа, медицинская карта со справками нарколога и психиатра.
...
- **Система недвижимости и жилья (`FloVMP.Core.Housing`):**
  - Объекты недвижимости: Апартаменты («Москва-Сити»), квартиры («Тверской бульвар»), особняки («Барвиха Luxury») и гаражи.
  - Покупка, продажа (75% возврат), сейфы для хранения наличных, ключи и подселение жильцов.
  - Команды: `/buyhouse`, `/sellhouse`, `/enter`, `/exit`, `/hlock`, `/house`.
- **Кастомизация внешности и форма фракций (`FloVMP.Core.Characters`):**
  - `CharacterAppearance`: генетика HeadBlend, 20 микро-черт лица, наложения (бороды/макияж), причёски, одежда и пропсы.
  - `FactionUniformService`: автоматическая выдача служебного обмундирования по званию для МВД (ППСП/офицеры), ФСБ (спецназ), ГКБ (халаты) и ВС РФ (Ратник).
