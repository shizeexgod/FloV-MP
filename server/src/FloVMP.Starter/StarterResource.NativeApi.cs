...
public partial class StarterResource
{
    private void RegisterNativeApi()
    {
        ...
        // --- бой ------------------------------------------------------------------------
        // Ответ на событие flovmp:damage. Звать можно прямо в обработчике
        // этого события: попадание ждёт решения до следующего тика сервера.
        // Ответ на уже закрытый вопрос отбрасывается — чужому выстрелу он не
        // достанется.
