...
/// <summary>
/// Реестр и сервис выдачи служебной формы государственных ведомств «Держава Онлайн».
/// </summary>
public static class FactionUniformService
{
    public static void ApplyUniform(CharacterAppearance appearance, int factionId, int rankLevel)
    {
