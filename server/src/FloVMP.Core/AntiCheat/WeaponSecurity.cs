...
public class WeaponSecurity
{
        ...
        out string violationReason)
    {
        ...
        // Fist / Unarmed (0xA271924C standard, 0xA2719263, 0xA2719248) is always allowed
        if (weaponHash == 0 || weaponHash == 0xA271924C || weaponHash == 0xA2719263 || weaponHash == 0xA2719248)
            return true;
