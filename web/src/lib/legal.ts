...
export const LEGAL: LegalConfig = {
  ...
  serviceName: 'FloV:MP',
  serviceDescription:
    'Автономный мультиплеерный движок для GTA V и веб-панель управления игровыми проектами: сетевой рантайм, лицензирование, консоль серверов, телеметрия, биллинг, FastDL CDN и сборщик лаунчера.',
  priceRub: 25000,
