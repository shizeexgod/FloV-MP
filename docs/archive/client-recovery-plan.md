> **АРХИВ (2026-08-29).** Реконструкция клиента из CEF + файлов Majestic
> больше не используется: взят настоящий официальный клиент alt:V 16.4.39
> из GTAMP-пейлоада (`../engine/gtamp-reference.md`,
> `scripts/import-altv-client.ps1`). Документ оставлен как история.
...
Форумчанин прислал проект **GTAMP** (`docs/engine/gtamp-reference.md`). В нём
...
`127.0.0.1:7788`.** См. `docs/instructions/live-test-guide.md`.
...
- Клиент в бэкапе: **17 из 85 файлов** (см. `docs/engine/client-direct-connect.md`).
