...
& dotnet publish $starterProj -c $Configuration -o $starterOut --nologo
if ($LASTEXITCODE -ne 0) { throw "dotnet publish FloVMP.Starter failed with exit code $LASTEXITCODE" }
